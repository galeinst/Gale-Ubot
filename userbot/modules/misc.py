...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/galeinst/Gale-Ubot"
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Gale-Ubot....`")
...
async def killdabot(event):
    await event.edit("`Restarting Gale-Ubot...`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[☠️ Gale-Project Repo](https://github.com/galeinst/Gale-Ubot/blob/Gale-Ubot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╭‒─‒──────────‒─‒╮\n"
        "│                   ʀᴇᴘᴏ\n"
        "│       [☠️ Gale-Ubot ☠️](https://github.com/galeinst/Gale-Ubot)\n"
        "├‒─‒──────────‒─‒╯\n"
        "│🔰 **ᴏᴡɴᴇʀ :** [G](t.me/gstwne)\n"
        "╰‒─‒──────────‒─‒╯\n"
        "  𝗟𝗶𝗰𝗲𝗻𝘀𝗲 : [GPL-3.0 License](https://github.com/galeinst/Gale-Ubot/blob/Gale-Ubot/LICENSE)"
    )
