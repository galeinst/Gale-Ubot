...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [𝗥𝗘𝗣𝗢-ᴋᴇɴ​](https://github.com/KennedyProject/KEN-UBOT)\n👥 : [KEN-𝗧𝗘𝗔𝗠](t.me/zeusspam)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/xgothboi)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/KEN-UBOT)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/zeusspam)  |  "
        f"[𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://Instagram.com/acxken._)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
